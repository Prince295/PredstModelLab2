...
class ThemedMessage1(interface.Entry):
    def __init__(self, parent = None, **configs):
        interface.Entry.__init__(self, parent, **configs)
        self.pack()
        self.config(fg='black', bg = 'white', font = 'times 14', relief='solid', justify = 'center', width = 25, disabledbackground='#fce5ff' , disabledforeground='black')
